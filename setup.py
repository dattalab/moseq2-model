...
setup(
    ...
    platforms='any',
    python_requires='>=3.6',
    setup_requires=['numpy', "future", "six", "autoregressive==0.1.1", "pybasicbayes==0.2.4"],
    install_requires=['six==1.14.0', 'h5py==2.10.0', 'scipy==1.3.3', 'numpy==1.17.4', 'click==7.0', 'cython==0.29.14',
